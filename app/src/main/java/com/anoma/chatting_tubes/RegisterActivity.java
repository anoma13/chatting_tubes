...
public class RegisterActivity extends AppCompatActivity {
    ...
    FirebaseAuth mauth;
    TextInputLayout etdisplayname,etemail,etpassword,etpassword2;
    Button buttonsubmit;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        etpassword2=(TextInputLayout)findViewById(R.id.editText5_2);
    ...
    public void buttonIsClicked(View view){
        ...
        if(view.getId()==R.id.button3){
            ...
            if(displayname.equals("")){
                Toast.makeText(RegisterActivity.this, "Please Fill the username", Toast.LENGTH_SHORT).show();
                return;
            }
            ...
            if(password2.equals("")){
                Toast.makeText(RegisterActivity.this, "Please Fill the confirm password", Toast.LENGTH_SHORT).show();
                return;
            }
            if (!password2.equals(password)){
                Toast.makeText(RegisterActivity.this, "Password do not same", Toast.LENGTH_SHORT).show();
                return;
            }
        ...
        mauth.createUserWithEmailAndPassword(email,password).addOnCompleteListener(this,new OnCompleteListener<AuthResult>() {
            ...
            public void onComplete(@NonNull Task<AuthResult> task) {
                ...
                if(task.isSuccessful()){
                    ...
                    userMap.put("status","Hello Anoma_lee");
