...
public class LoginActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        etforgotpass = findViewById(R.id.forgotpass);

        mauth= FirebaseAuth.getInstance();
        mDatabaseReference = FirebaseDatabase.getInstance().getReference().child("users");

        etforgotpass.setOnClickListener(new View.OnClickListener() {
            @Override
    ...
    public void buttonIsClicked(View view){
        ...
        switch(view.getId()){
            ...
            case R.id.buttonSign:
                ...
                if(email.equals("")){
                    Toast.makeText(LoginActivity.this, "Please Fill the email", Toast.LENGTH_SHORT).show();
                    return ;
                }
                ...
                new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        ...
                        if(task.isSuccessful()){
                            ...
                            Toast.makeText(LoginActivity.this, "Account not Registered" +
